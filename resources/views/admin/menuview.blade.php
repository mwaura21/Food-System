                    ...
                    <div class="row">
                        <div class="col-lg-12 margin-tb">
                            ...
                            <div class="float-right">
                                <a class="btn btn-success" href="{{ route('smenu.vendor',$category->vendor) }}"> Back</a>
                            </div>
                        </div>
                    </div>
                        ...
                        @endif
                        <form action="{{ route('smenu.deleteAll') }}" method="POST">    
                        ...
                        @method('DELETE')
                            ...
                            <div class="row">
                                <div class="col-lg-12 margin-tb">
                                    ...
                                    <div class="float-right">
                                        <a class="btn btn-success" href="{{ route('smenu.create',$category) }}"> Create New Item</a>
                                    </div>
                                </div>
                            </div>
                                <br>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <a class="btn btn-success" href="{{ route('smenu.edit',$menu->id) }}">Edit</a>
                                    </td>
                                </tr>
                                </form>
                            @endforeach
