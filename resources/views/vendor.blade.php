...
<div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-inverse navbar-dark">
              ...
              <ul class="nav navbar-nav justify-content-center">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('vendor.showupdateform') }}" >Edit Profile</a>
          ...
          <div class="container-fluid admin-container row">
            <div class="col-md-6">
                <a href="{{ route('menu.index') }}" class="btn btn-outline-light" role="button">Menu
                    <span><img src="{{ asset('storage/images/menu-icon.jpg') }}" alt=""></span>
                </a>
                <a href="{{ route('orders') }}" class="btn btn-outline-light" role="button">Orders
                    <span><img src="{{ asset('storage/images/Messages-icon.jpg') }}" alt=""></span>
                </a>
            </div>

            <div class="col-md-6">
                <a href="{{ route('vendor.showupdateform') }}" class="btn btn-outline-light" role="button">My account
                    <span><img src="{{ asset('storage/images/Messages-icon.jpg') }}" alt=""></span>
                </a>
