...
<body>
    ...
    @include('include.adminnav')
        @if (Route::current()->getName() == 'smenu.create')
            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="float-right">
                        <a class="btn btn-success" href="{{ route('scategory.viewAll',$category->id) }}"> Back</a>
                    </div>
                </div>
            </div>
        
            <form action="{{ route('smenu.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" id="vendor" name="vendor" value="{{ $category->vendor }}">
        ...
        @elseif (Route::current()->getName() == 'scategories.create')
        <div class="container mt-5">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-left">
                    ...
                    <div class="float-right">
                        <a class="btn btn-success" href="{{ route('smenu.vendor',$vendor->id) }}"> Back</a>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('scategory.store') }}" method="POST">
                @csrf
                <input type="hidden" id="vendor" name="vendor" value="{{ $vendor->id }}">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Name</strong>
